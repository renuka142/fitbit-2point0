    ...
    function displayone() { 
        var ele = document.getElementsByName('qlist'); 
        
        for(i = 0; i < ele.length; i++) { 
            if(ele[i].checked) 
                document.getElementById("result_one").innerHTML
                    = "Category Selected: "+ele[i].value; 
        } 
    } 
    function displaytwo() { 
    ...
    function displayRadioValueone() { 
        var ele = document.getElementsByName('upper'); 
        
        for(i = 0; i < ele.length; i++) { 
            if(ele[i].checked) 
                document.getElementById("resultone").innerHTML
                    = "Upper Body: "+ele[i].value; 
        } 
    } 
    function displayRadioValuetwo() { 
        var ele = document.getElementsByName('lower'); 
        
        for(i = 0; i < ele.length; i++) { 
            if(ele[i].checked) 
                document.getElementById("resulttwo").innerHTML
                    = "Lower Body: "+ele[i].value; 
        } 
    } 
  ...
  function toggleone(){
    ...
    popupone.classList.togglenew('active');
  }
