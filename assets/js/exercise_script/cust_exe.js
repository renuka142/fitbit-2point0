        ...
        for(j = 0; j < two.length; j++){
            if(one[i].checked && two[j].checked){
                if(one[i].value==="Shoulder" && two[j].value==="Legs")
                    document.getElementById("resultfour").innerHTML="<b>"+"Exercises for Shoulder And Legs"+"</b>"+"<br>"+"<br>"+"Back Squat 3 x 8-10 reps"+"<br>"+"Front Squat 2 x 8-10 reps"+"<br>"+"Face Pull 3 x 15 reps"+"<br>"+"Walking Lunge 3 x 8-12 reps"+"<br>"+"<br>"+"<br>"+"Rest 30-45 seconds between sets (60-90 seconds between sets of squats, if neccessary)"+"<br>"
